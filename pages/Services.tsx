            ...
            >
              ...
              <div className="w-full md:w-1/2">
                <div className="flex items-center space-x-3 mb-4">
                   <span className="text-6xl font-black text-gray-100 -ml-4 select-none">0{idx + 1}</span>
                   <span className="px-3 py-1 bg-blue-50 text-primary text-xs font-bold rounded-full uppercase">专业服务</span>
                </div>
