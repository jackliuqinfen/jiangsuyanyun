      ...
      <div className="container mx-auto px-6 py-12">
         <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <aside className="hidden lg:block w-64 flex-shrink-0 sticky top-28">
               ...
               {/* Quick Access Widget */}
               {!searchTerm && (
                  <div className="mt-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-6 text-white shadow-xl">
                     <div className="flex items-center gap-2 mb-4 text-accent">
                        <MapPin size={18} />
                        <span className="font-bold text-sm">线下办事大厅</span>
                     </div>
                     <div className="space-y-4">
                        <div className="bg-white/10 rounded-xl p-3 border border-white/5 hover:bg-white/20 transition-colors cursor-pointer">
                           <p className="font-bold text-xs mb-1">江苏省政务服务中心</p>
                           <p className="text-[10px] text-white/60">南京市建邺区汉中门大街145号</p>
                        </div>
                        <div className="bg-white/10 rounded-xl p-3 border border-white/5 hover:bg-white/20 transition-colors cursor-pointer">
                           <p className="font-bold text-xs mb-1">盐城市行政审批局</p>
                           <p className="text-[10px] text-white/60">盐城市府西路1号</p>
                        </div>
                     </div>
                  </div>
               )}
