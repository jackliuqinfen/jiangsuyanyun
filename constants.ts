...
export const INITIAL_SERVICES: Service[] = [
  { 
    id: '1', 
    title: '工程监理', 
    description: '提供全过程、全方位的工程监理服务，确保工程质量、进度 and 安全。', 
...
export const INITIAL_HONORS: Honor[] = [
  { id: '1', title: '工程监理综合甲级资质', issueDate: '2020-05', issuingAuthority: '住房和城乡建设部', content: '<h3>资质说明</h3><p>该资质是我司核心竞争力的体现，标志着我司具备承接所有专业类别建设工程项目的工程监理业务能力。无需受工程类别 and 等级限制。</p>', imageUrl: 'https://placehold.co/300x400/fff/gold?text=Certificate+A', categoryId: 'cat_qual' },
